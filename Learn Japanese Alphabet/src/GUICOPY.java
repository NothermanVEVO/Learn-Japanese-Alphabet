...
// public class GUICOPY extends JPanel implements ActionListener {

//     //! OPTIONS
//     //? 
//     boolean has_hiragana_alphabet;
//     boolean has_katakana_alphabet;
...
//     int option;
    ...
    // //? HIRAGANA VARIABLES
    // String[] hiragana_symbols_A = {"あ", "か", "さ", "た", "な", "は", "ま", "や", "ら", "わ", "が", "ざ", "だ", "ば", "ぱ"};
    // String[] hiragana_correct_answer_A = {"A", "Ka", "Sa", "Ta", "Na", "Ha", "Ma", "Ya", "Ra", "Wa", "Ga", "Za", "Da", "Ba", "Pa"};

    // String[] hiragana_symbols_E = {"え", "け", "せ", "て", "ね", "へ", "め", "れ", "げ", "ぜ", "で", "べ", "ぺ"};
    // String[] hiragana_correct_answer_E = {"E", "Ke", "Se", "Te", "Ne", "He", "Me", "Re", "Ge", "Ze", "De", "Be", "Pe"};

    // String[] hiragana_symbols_I = {"い", "き", "し", "ち", "に", "ひ", "み", "り", "ぎ", "じ", "ぢ", "び", "ぴ"};
    // String[] hiragana_correct_answer_I = {"I", "Ki", "Shi", "Chi", "Ni", "Hi", "Mi", "Ri", "Gi", "Ji", "Ji", "Bi", "Pi"};

    // String[] hiragana_symbols_O = {"お", "こ", "そ", "と", "の", "ほ", "も", "よ", "ろ", "を", "ご", "ぞ", "ど", "ぼ", "ぽ"};
    // String[] hiragana_correct_answer_O = {"O", "Ko", "So", "To", "No", "Ho", "Mo", "Yo", "Ro", "O", "Go", "Zo", "Do", "Bo", "Po"};

    // String[] hiragana_symbols_U = {"う", "く", "す", "つ", "ぬ", "ふ", "む", "ゆ", "る", "ぐ", "ず", "づ", "ぶ", "ぷ"};
    // String[] hiragana_correct_answer_U = {"U", "Ku", "Su", "Tsu", "Nu", "Fu", "Mu", "Yu", "Ru", "Gu", "Zu", "Zu", "Bu", "Pu"};

    // //? KATAKANA VARIABLES
    // String[] katakana_symbols_A = {"あ", "か", "さ", "た", "な", "は", "ま", "や", "ら", "わ", "が", "ざ", "だ", "ば", "ぱ"};
    // String[] katakana_correct_answer_A = {"A", "Ka", "Sa", "Ta", "Na", "Ha", "Ma", "Ya", "Ra", "Wa", "Ga", "Za", "Da", "Ba", "Pa"};

    // String[] katakana_symbols_E = {"え", "け", "せ", "て", "ね", "へ", "め", "れ", "げ", "ぜ", "で", "べ", "ぺ"};
    // String[] katakana_correct_answer_E = {"E", "Ke", "Se", "Te", "Ne", "He", "Me", "Re", "Ge", "Ze", "De", "Be", "Pe"};

    // String[] katakana_symbols_I = {"い", "き", "し", "ち", "に", "ひ", "み", "り", "ぎ", "じ", "ぢ", "び", "ぴ"};
    // String[] katakana_correct_answer_I = {"I", "Ki", "Shi", "Chi", "Ni", "Hi", "Mi", "Ri", "Gi", "Ji", "Ji", "Bi", "Pi"};

    // String[] katakana_symbols_O = {"お", "こ", "そ", "と", "の", "ほ", "も", "よ", "ろ", "を", "ご", "ぞ", "ど", "ぼ", "ぽ"};
    // String[] katakana_correct_answer_O = {"O", "Ko", "So", "To", "No", "Ho", "Mo", "Yo", "Ro", "O", "Go", "Zo", "Do", "Bo", "Po"};

    // String[] katakana_symbols_U = {"う", "く", "す", "つ", "ぬ", "ふ", "む", "ゆ", "る", "ぐ", "ず", "づ", "ぶ", "ぷ"};
    // String[] katakana_correct_answer_U = {"U", "Ku", "Su", "Tsu", "Nu", "Fu", "Mu", "Yu", "Ru", "Gu", "Zu", "Zu", "Bu", "Pu"};
